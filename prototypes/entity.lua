...
{
	{
		...
		minable = {mining_time = 1, result = "modularTank"},
		max_health = 1500,
				...
				action =
				{
					...
					action_delivery =
					{
						...
						source_effects =
						{
							{
								type = "create-entity",
								entity_name = "modularTank-damaged",
  	...
  	{
		type = "tree",
		name = "modularTank-damaged",
		icon = "__modularTanks__/graphics/null.png",
		...
		{
			{
				filename = "__modularTanks__/graphics/null.png",
				width = 32,
				height = 32,
			}
		}
